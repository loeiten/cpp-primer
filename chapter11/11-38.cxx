...
unordered_map<string, string>* buildMap(
    ifstream* mapFilePtr, unordered_map<string, string>* transformMapPtr) {
  string key;
  string value;
...
string transform(ifstream* textFilePtr,
                 unordered_map<string, string>* transformMapPtr) {
  string line;
  string word;
...
string getTransformedText(ifstream* mapFilePtr, ifstream* textFilePtr) {
  unordered_map<string, string> transformMap;
  unordered_map<string, string>* transformMapPtr = &transformMap;
